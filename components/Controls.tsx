          ...
          >
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  title="Supports: +, -, *, /, ^, fib(n), fact(n), prime(n), pi(n), sin, cos, tan, log, sqrt, abs, floor, ceil, round, exp"
                />
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <input
                ...
                title="Supports: comparisons (==, !=, <, <=, >, >=), logic (&&, ||, !), +, -, *, /, ^, gcd(a,b), spf(n)/lpf(n), gpf(n), fib(n), fact(n), prime(n), pi(n), sin, cos, tan, log, sqrt, abs, floor, ceil, round, exp"
              />
